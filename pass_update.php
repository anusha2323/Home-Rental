...
if(isset($_REQUEST['update_pass']))
{
    ...
    if(!empty($cpass) && !empty($pass))
    {
        if($cpass === $pass){
            ...
            if($result){
                $msg = "<p class='alert alert-success'>Pass Updated Successfully</p> ";
            }
            else{
                $error = "<p class='alert alert-warning'>Pass Updation Not Successfully</p> ";
            }
        }
    }else{
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
                                ...
                                <div class="form-group">
                                    ...
                                    <button class="btn btn-success" name="update_pass" value="update_pass" type="submit">Update</button>
								</form>
